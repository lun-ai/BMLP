...
fb15k_file_paths = [src_path + 'train.txt',
                    src_path + 'valid.txt', src_path + 'test.txt']
...
pairs = [('location', obj) for obj in objects]

# Print a summary of the triples extracted.
print(
    f"Extracted {len(triples)} triples, {len(objects)} objects and saved them to {output_file_path1}.")
